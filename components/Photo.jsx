  ...
  return (
    <div className="w-full h-full relative">
      <motion.div initial={{opacity:0}} animate={{opacity: 1,
        ...
        className="w-[298px] h-[298px] xl:w-[498px] xl:h-[498px] relative rounded-full overflow-hidden shadow-lg mix-blend-lighten"
        >
          <Image 
            src="/Gemini_Generated_Image_i5no45i5no45i5no.png" 
            priority 
            quality={100} 
            fill 
            alt="Profile photo" 
